...
use Ajgl\Security\Http\Session\ConcurrentSessionControlAuthenticationStrategy;
...
class ConcurrentSessionControlAuthenticationStrategyTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @expectedException Ajgl\Security\Core\Exception\MaxSessionsExceededException
    ...
    {
        $sessionInfo = $this->getMockBuilder('Ajgl\Security\Http\Session\Registry\SessionInformation')
            ->disableOriginalConstructor()
            ->getMock();
